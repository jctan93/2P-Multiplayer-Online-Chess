...
$(document).ready(function(){
    ...
    $(document).on('submit', 'form', function() {
		...
		{
			//console.log("ENTERS HERE $(this).attr(name) == chat-form-global");
			...
			if(user_logged_in == player_one)
			{
				...
				var appendtwo = user_logged_in + ": " +document.getElementById("chat-input-global").value;
	...
	*/
	...
	//Moves the selected piece if it's a legal move
	$(document).on('click',"#confirm_button",function()
	{
			var cookies = getCookie("login_cookie") + ":" + getCookie("session_details");
			console.log("Check validity: " + cookies);
			socket.emit('check validity', cookies);
			//console.log("Origin square: " + origin_square);
			//console.log("Destination square: " + destination_square);
